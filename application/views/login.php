...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo base_url(); ?>public/login/images/img-01.jpg');">
			<div class="wrap-login100 p-t-190 p-b-30">
				<form class="login100-form validate-form">
					<div class="login100-form-avatar">
						<img src="<?php echo base_url(); ?>public/login/images/login-logo.png" alt="AVATAR">
					</div>

					<span class="login100-form-title p-t-20 p-b-45">
						Sinkronisasi Kegiatan RKPD 2020
					</span>
					...
					<div class="text-center w-full p-t-25 p-b-230">
						<a href="#" class="txt1">
							Lupa Username dan Password? Silahkan Kontak Admin
						</a>
					</div>
